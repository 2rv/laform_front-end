...
export function ProductOptions(props) {
  ...
  const fieldArrayName = SEWING_GOODS_FIELD_NAME.OPTIONS;
  const optionSizeName = SEWING_GOODS_FIELD_NAME.OPTION_SIZE;
  const optionColorName = SEWING_GOODS_FIELD_NAME.OPTION_COLOR;
  const optionPriceName = SEWING_GOODS_FIELD_NAME.OPTION_PRICE;
  const optionDiscountName = SEWING_GOODS_FIELD_NAME.OPTION_DISCOUNT;
